...
const EXISTING_SAINTS_CATALOG = [
  ...
  },
  {
    ...
    "rarity": "legendary",
    "unlockCondition": "milestone_20_books",
  ...
  },
  {
    ...
    "unlockCondition": "milestone_100_books",
...
const NEW_SAINTS_TO_ADD = [
  // Example of future saints you might add:
  {
    "id": "saint_138",
    "name": "St. Frances of Rome",
    "patronage": "Motorists, Widows",
    "feast_day": "March 9",
    "short_blurb": "Patron saint of drivers and automobile drivers.",
    "extra_fact": "Often depicted with a guardian angel holding a lantern.",
    "icon_asset": "assets/saints/saint_frances_rome.png",
    "rarity": "common",
    "unlockCondition": "streak_7_days",
    "luxlings_series": "Pocket Patrons"
  },
  {
    "id": "saint_139", 
    "name": "St. Josephine Margaret Bakhita",
    "patronage": "Human Trafficking Victims",
    "feast_day": "February 8",
    "short_blurb": "Overcame slavery to become a religious sister.",
    "extra_fact": "Patron saint against human trafficking.",
    "icon_asset": "assets/saints/saint_bakhita_new.png",
    "rarity": "rare",
    "unlockCondition": "streak_30_days", 
    "luxlings_series": "Virtue Vignettes"
  }

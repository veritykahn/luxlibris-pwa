...
export const BADGE_CALENDAR = {
  ...
  1: { 
    ...
    birdFact: "They're the only birds that can fly backwards and their hearts beat 1,200 times per minute during flight."
  },
  2: { 
    ...
    birdFact: "They dive into water at 25 mph and can adjust for light refraction to catch fish with incredible accuracy."
  },
  3: { 
    ...
    birdFact: "Only males are bright red; females are brown to stay camouflaged while sitting on eggs."
  },
  4: { 
    name: "Flamingo Focus", 
    ...
    birdFact: "They're pink because they eat shrimp and algae rich in carotenoids - zoo flamingos turn white without this diet!"
  },
  5: { 
    name: "Toucan Triumph", 
    pngName: "toucan.png", 
    ...
    birdFact: "Their massive colorful bills are actually lightweight and work like air conditioners to regulate body temperature."
  },
  6: { 
    name: "Peacock Pride", 
    pngName: "peacock.png", 
    ...
    birdFact: "Their tail feathers can have over 200 iridescent \"eye-spots\" that shimmer with colors that don't exist in any paint."
  },
  7: { 
    ...
    birdFact: "Their throat pouch can hold up to 3 gallons of water - more than their stomach can hold!"
  },
  8: { 
    ...
    birdFact: "They can live over 80 years and have beaks strong enough to crack coconuts and even small bones."
  },
  9: { 
    ...
    birdFact: "They can soar for hours without flapping and have the longest wingspan of any bird - up to 12 feet!"
  },
  10: { 
    name: "Puffin Power", 
    pngName: "puffin.png", 
    ...
    birdFact: "They can hold up to 60 small fish crosswise in their colorful beaks at once without dropping any!"
  },
  11: { 
    name: "Heron Habits", 
    pngName: "heron.png", 
    ...
    birdFact: "They can stand motionless for over an hour, then strike with lightning speed in 1/10th of a second."
  },
  12: { 
    ...
    birdFact: "They have completely waterproof feathers and can sleep with one eye open to watch for predators."
  },
  13: { 
    ...
    birdFact: "They're not actually bald - their white head feathers just make them appear so from a distance."
  },
  ...
  14: { 
    ...
    xp: 75, 
    type: "timer", 
    description: "Complete your first reading session of the new school year",
    birdFact: "They can navigate using Earth's magnetic field and are one of the few animals that can recognize themselves in mirrors."
  },
  15: { 
    ...
    birdFact: "They catch bees in mid-flight and expertly remove the stinger by rubbing it on branches before eating."
  },
  16: { 
    ...
    xp: 85, 
    type: "content", 
    description: "Update progress on 1 book this week",
    birdFact: "They have shock-absorbing skulls and tongues that wrap around their brains to prevent damage while hammering."
  },
  17: { 
    name: "Goose Goals", 
    pngName: "goose.png", 
    xp: 65, 
    type: "timer", 
    description: "Exceed your weekly reading goal by 50%",
    birdFact: "They fly in V-formations because each bird gets a lift from the wingtip vortex of the bird ahead, saving 20% energy."
  },
  18: { 
    name: "Quetzal Quest", 
    pngName: "quetzal.png", 
    ...
    birdFact: "Ancient Maya and Aztecs considered their tail feathers more valuable than gold and killing one was punishable by death."
  },
  19: { 
    ...
    type: "timer", 
    description: "Complete a 45+ minute reading session",
    birdFact: "They can run 45 mph and their eggs are so large that one can make an omelet for 8 people!"
  },
  20: { 
    ...
    type: "timer", 
    description: "Complete a 60+ minute reading session",
    birdFact: "Males perform elaborate dances and have some of the most spectacular plumage on Earth - their feathers can look like alien creatures!"
  },
  21: { 
    name: "Pheasant Focus", 
    ...
    type: "timer", 
    description: "Complete 2+ morning sessions (before 9am) this week",
    birdFact: "Males have incredibly long, colorful tail feathers that can be over 2 feet long and are shed annually."
  },
  22: { 
    ...
    birdFact: "They have the strongest stomach acid of any animal (pH of 1), allowing them to safely digest rotten meat."
  },
  23: { 
    ...
    type: "timer", 
    description: "Read 3+ hours total this week (180+ minutes)",
    birdFact: "Considered the world's most dangerous bird, they can kill with their dagger-like middle toe claw."
  },
  24: { 
    name: "Raven Ratings", 
    pngName: "raven.png", 
    ...
    birdFact: "They can learn to mimic human speech, use tools, and even play games like sliding down snowy hills for fun."
  },
  25: { 
  ...
  26: { 
    ...
    birdFact: "They can recognize individual human faces, hold grudges for years, and even pass hatred of specific people to their offspring."
  },
  27: { 
    name: "Swan Serenity", 
    pngName: "swan.png", 
  ...
  32: { 
    ...
    xp: 75, 
    type: "timer", 
    description: "Average 30+ minutes per session this week",
  ...
  37: { 
    ...
    xp: 70, 
    type: "timer", 
    description: "Read 20+ minutes both Saturday AND Sunday",
  ...
  38: { 
    ...
    xp: 85, 
    type: "timer", 
    description: "Read at different times each day (morning, afternoon, evening)",
  ...
  39: { 
    ...
    xp: 65, 
    type: "timer", 
    description: "Read more minutes than last week",
...
export const checkTimerBadgeProgress = async (studentData, sessionData, weekNumber) => {
  ...
  switch (badge.name) {
    ...
    default:
      // For seasonal badges and others, award during the week
      if (badge.type === 'timer') {
        return { earned: true, badge };
      }
      break;

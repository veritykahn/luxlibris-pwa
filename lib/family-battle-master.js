...
// ✅ DEFENSIVE CHECK: Auto-fix wrong structure
  if (familyData.familyBattle && !familyData.familyBattle.history) {
    console.warn('⚠️ AUTO-FIX: Family missing nested history structure, fixing now...');
    
    const legacyHistory = familyData.familyBattleHistory || {};
    
    transaction.update(familyRef, {
      'familyBattle.history': {
        totalBattles: legacyHistory.totalBattles || 0,
        childrenWins: legacyHistory.childrenWins || 0,
        parentWins: legacyHistory.parentWins || 0,
        ties: legacyHistory.ties || 0,
        currentStreak: legacyHistory.currentStreak || { team: null, count: 0 },
        recentBattles: legacyHistory.recentBattles || [],
        xpAwarded: legacyHistory.xpAwarded || {}
      },
    ...
    console.log('✅ AUTO-FIX: Structure corrected, continuing with archive...');
  }

...
export const authHelpers = {
  ...
  createStudentAccount: async (firstName, lastInitial, schoolJoinCode) => {
    try {
      ...
      console.log('🔐 Creating Firebase Auth account with:', { studentEmail, passwordLength: studentPassword.length });
      ...
      return {
        ...
        password: studentPassword, // Return the actual password created  
        firstName,
        lastInitial,
        schoolJoinCode,
        accountType: 'student'

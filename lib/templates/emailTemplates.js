...
export const emailTemplates = {
  ...
  programStart: {
    ...
    dynamicFields: {
      ...
      TOTAL_BOOKS: 'Total number of books (typically 20)',
...
🏆 **Real-World Rewards** - The achievements you've always treasured, now with app tracking:
   ...
   • 10 books: Recognition + Certificate
   • 15 books: Recognition + Certificate + End-of-Year Party (treats, prizes, and a brand new book!)
   • 20 books: Recognition + Certificate + Party + Beautiful Medal
   • 100 books across 5 years: Permanent plaque in the {{SCHOOL_NAME}} library
...
• **15 Books:** Our beloved end-of-year party with treats, prizes, and a brand new book!
• **20 Books:** Beautiful medal
• **100 Books (across 5 years):** Commemorative plaque in our {{SCHOOL_NAME}} library
...
P.S. Spring break reading counts too! Pack a book (or three) along with those beach toys or hiking boots. 🏖️📚`
  ...
  programEnd: {
    ...
    dynamicFields: {
      ...
      PARTY_DATE: '[TEACHER TO ADD: Date of achievement party for 15+ book readers]',
...
Your child's personal reading story this year has been unique and valuable. Whether they read 3 books or 23, they:
...
🎊 **{{PARTY_DATE}}:** Achievement party for students who read 15+ books (treats, prizes, and a brand new book to keep!)
...
export const fillEmailTemplate = (template, userData) => {
  let filledBody = template.body
  
  // Replace all dynamic fields
  Object.keys(template.dynamicFields).forEach(key => {
    const placeholder = `{{${key}}}`
    const value = userData[key] || placeholder // Keep placeholder if no data
...
// Example usage:
// const userData = {
//   TEACHER_FIRST_NAME: 'Verity',
//   TEACHER_LAST_NAME: 'Kahn',
//   SCHOOL_NAME: 'Holy Family',
//   STUDENT_JOIN_CODE: 'TXAUST-HOLY-KAHN58-STUDENT',
//   PARENT_QUIZ_CODE: 'ODLRPU20',
//   TOTAL_BOOKS: '20',
//   WEBSITE_URL: 'luxlibris.org/role-selector'
// }
// 
// const filledEmail = fillEmailTemplate(emailTemplates.programStart, userData)
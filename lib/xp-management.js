 ...
 */
export const awardXP = async (studentData, xpAmount, type, details = {}) => {
  try {
 ...
 */
export const awardReadingXP = async (studentData, duration, sessionId) => {
 ...
 */
export const awardBadgeXP = async (studentData, weekNumber, source = 'unknown') => {
 ...
 */
export const awardFamilyBattleXP = async (studentData, weekNumber, isMVP = false, source = 'family_battle') => {
 ...
 */
export const getXPHistory = async (studentData, limitCount = 100) => {
  try {
    const xpHistoryRef = collection(
      db,
      `entities/${studentData.entityId}/schools/${studentData.schoolId}/students/${studentData.id}/xpHistory`
 ...
 */
export const calculateXPFromHistory = async (studentData) => {
  try {
 ...
 */
export const validateTotalXP = async (studentData) => {
  try {
    let calculatedXP = 0;
    const validation = {
      sources: {},
 ...
 */
export const reconcileXP = async (studentData, useHistoryTotal = false) => {
  try {
 ...
 */
export const getWeeklyXP = async (studentData) => {
  try {
 ...
 */
export const getXPAuditReport = async (studentData) => {
  try {
    const validation = await validateTotalXP(studentData);
